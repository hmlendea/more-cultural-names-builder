...
namespace MoreCulturalNamesBuilder.UnitTests.Service
{
    ...
    {
        const string StringOfVariousCharacters = "*[] °ʹ–—‘’”‡′″̲̓́̀̆̂̌̈̋̃áÁàÀăĂắẵâÂấẤầẩǎåÅäÄãÃąāĀảẢȁạặậæÆǣḇćĆĉĈčČċĊçÇďĎḑđĐḍḌḏḎðÐɖéÉèÈĕĔêÊếềểěĚëËẽėĖęĘēĒḗḖẹẸệǝəƏɛƐḟḞǵǴğĞĝĜǧǦġĠģĢḡɣƔƣƢĥĤȟȞḧḩḨħĦḥḤḫḪẖʻʽíÍìÌĭĬîÎǐïÏḯĩİįĮīĪỉịıɨɩʲĵĴǰḱḰǩǨķĶḳḲḵĺĹľĽļĻłŁḷƚɬṁṃⁿńŃňŇñÑṅņŅṇṉɲŋóÓòÒŏŎôÔốồổǒöÖőõÕøØǿǾǫǭōŌṓỏơớờỡợọỌộœŒɔƆṗɸŕřŘṙṘṛṚṟśŚŝŜšŠṡşŞṣṢșȘßťŤẗţṭṬțȚṯṮŧúÚùÙŭŬûÛǔůüÜǜǚűũųūŪủưứừửụṳʊṿỽŵẆẍýÝỳŷẏȳȝȜźŹžŽżŻẓẒƶƵʐǯþÞƿǷʼʾꞌʿΆεθΊΐοΟόΎаАәВгеёіІїјклноОПТухХџьяپڭॎᐋ";
